...
// ===== SERVICES (body-area treatments) =====
// These go into the `services` collection. Each gets a /services/[slug] path.
export const services = [
  {
    ...
    bodyAreas: ['lips'],
    avgPriceFromUsd: 600, avgPriceToUsd: 1100, priceUnit: 'per_syringe',
  },
  {
    name: 'Cheek Filler',
    slug: 'cheek-filler',
    ...
    bodyAreas: ['cheeks'],
    avgPriceFromUsd: 800, avgPriceToUsd: 1600, priceUnit: 'per_session',
  },
  {
    name: 'Jawline Filler',
    slug: 'jawline-filler',
    ...
    avgPriceFromUsd: 900, avgPriceToUsd: 1800, priceUnit: 'per_session',
  },
  {
    ...
    bodyAreas: ['under-eye'],
    avgPriceFromUsd: 750, avgPriceToUsd: 1500, priceUnit: 'per_session',
  },
  {
    name: 'Forehead Botox',
    slug: 'forehead-botox',
    category: 'body-area',
    tagline: 'Smooth horizontal forehead lines without freezing.',
    shortDescription: 'Neurotoxin placed in the frontalis muscle to reduce forehead wrinkles.',
    bodyAreas: ['forehead'],
    avgPriceFromUsd: 200, avgPriceToUsd: 500, priceUnit: 'per_session',
  },
  {
    name: 'Masseter Botox',
    slug: 'masseter-botox',
    ...
    bodyAreas: ['jawline'],
    avgPriceFromUsd: 500, avgPriceToUsd: 900, priceUnit: 'per_session',
  },
  {
    name: 'Brow Lift',
    slug: 'brow-lift',
    category: 'body-area',
    tagline: 'Lift and arch the brow with a few precise units.',
    shortDescription: 'Strategic neurotoxin placement elevates the outer brow for a refreshed look.',
    bodyAreas: ['brow'],
    avgPriceFromUsd: 150, avgPriceToUsd: 400, priceUnit: 'per_session',
  },
  {
    name: 'Thread Lift',
    slug: 'thread-lift',
    ...
    avgPriceFromUsd: 1500, avgPriceToUsd: 4000, priceUnit: 'per_session',
  },
  {
    name: 'PRP',
    slug: 'prp',
    ...
    avgPriceFromUsd: 600, avgPriceToUsd: 1200, priceUnit: 'per_session',
  },
  {
    name: 'Microneedling',
    slug: 'microneedling',
    ...
    avgPriceFromUsd: 300, avgPriceToUsd: 900, priceUnit: 'per_session',
  },
]

// ===== PRODUCT BRANDS =====
// These go into the `brands` collection. Each gets a /brands/[slug] path.
export const productBrands = [
  {
    ...
    tagline: 'The most recognized neurotoxin in the world.',
    shortDescription: 'OnabotulinumtoxinA temporarily relaxes muscles. FDA-approved for forehead lines, glabellar lines, and crow\'s feet.',
    avgPriceFromUsd: 280, avgPriceToUsd: 720, priceUnit: 'per_session',
  },
  {
    name: 'Dysport',
    slug: 'dysport',
    ...
    shortDescription: 'AbobotulinumtoxinA spreads more diffusely, which can be an advantage in larger areas like the forehead.',
    avgPriceFromUsd: 240, avgPriceToUsd: 680, priceUnit: 'per_session',
  },
  {
    name: 'Xeomin',
    slug: 'xeomin',
    ...
    tagline: 'A "naked" neurotoxin with no accessory proteins.',
    shortDescription: 'IncobotulinumtoxinA is formulated without complexing proteins, which may reduce antibody resistance over time.',
    avgPriceFromUsd: 260, avgPriceToUsd: 680, priceUnit: 'per_session',
  },
  {
    name: 'Jeuveau',
    slug: 'jeuveau',
    category: 'neurotoxin',
    manufacturer: 'Evolus',
    tagline: 'The first neurotoxin made exclusively for aesthetics.',
    shortDescription: 'PrabotulinumtoxinA was FDA-approved in 2019, developed solely for cosmetic use.',
    avgPriceFromUsd: 260, avgPriceToUsd: 680, priceUnit: 'per_session',
  },
  {
    name: 'Daxxify',
    ...
    tagline: 'The longest-lasting neurotoxin currently approved in the US.',
    ...
    avgPriceFromUsd: 450, avgPriceToUsd: 900, priceUnit: 'per_session',
  },
  {
    name: 'Juvederm',
    slug: 'juvederm',
    category: 'filler',
    manufacturer: 'Allergan Aesthetics',
    tagline: 'The leading HA filler family in the US.',
    shortDescription: 'A family of hyaluronic acid fillers including Voluma, Vollure, Volbella, and Ultra. Each formulation targets a different area and depth.',
    avgPriceFromUsd: 600, avgPriceToUsd: 1200, priceUnit: 'per_syringe',
  },
  {
    name: 'Restylane',
    slug: 'restylane',
    category: 'filler',
    manufacturer: 'Galderma',
    tagline: 'Galderma\'s full family of HA fillers.',
    shortDescription: 'Restylane products include Kysse for lips, Lyft for cheeks, Defyne and Refyne for mid-face, and Eyelight for tear troughs.',
    avgPriceFromUsd: 600, avgPriceToUsd: 1100, priceUnit: 'per_syringe',
  },
  {
    name: 'Sculptra',
    ...
    shortDescription: 'Poly-L-lactic acid stimulates collagen production. Effects build gradually over 3 to 6 months and last 2 to 3 years.',
    avgPriceFromUsd: 800, avgPriceToUsd: 1600, priceUnit: 'per_session',
  },
  {
    name: 'Radiesse',
    ...
    category: 'biostimulator',
    manufacturer: 'Merz Aesthetics',
    tagline: 'Immediate volume plus long-term collagen stimulation.',
    shortDescription: 'Calcium hydroxylapatite microspheres provide immediate lift and stimulate the body\'s own collagen production.',
    avgPriceFromUsd: 700, avgPriceToUsd: 1400, priceUnit: 'per_session',
  },
  {
    name: 'Kybella',
    slug: 'kybella',
    ...
    shortDescription: 'Deoxycholic acid injection that permanently destroys fat cells under the chin. Requires 2 to 4 sessions.',
    avgPriceFromUsd: 1200, avgPriceToUsd: 2400, priceUnit: 'per_session',
  },
]

// ===== TREATMENTS (kept for backward compat with providers seed only) =====
...
export const clinics = [
  ...
  },
  {
    ...
    aggregateRating: 4.8, aggregateRatingCount: 510,
    sourceUrls: [{ url: 'https://injector.world/seed' }], lastScrapedDate: new Date('2026-05-30').toISOString(),
  },
  {
...
export const guides: GuideSeed[] = [
  ...
  // Stub guides — nav links in site-nav.ts point here. Content team fills body via /admin.
  {
    title: 'Lip Filler: The Complete Guide',
    slug: 'lip-filler',
    lede: 'What to expect from lip filler, how much it costs, how long it lasts, and how to find an injector who will give you a natural result.',
    coverImageUrl: 'https://picsum.photos/seed/guide-lip-filler/1080/520',
    category: 'treatment-guide', treatmentSlug: 'lip-filler',
    readTimeMin: 10, sourcesCount: 6,
    authorSlug: 'hannah-reyes', reviewerSlug: 'lena-park-md',
    lastMedicallyReviewed: '2026-06-01', publishedAt: '2026-06-01',
  },
  {
    title: 'First-Time Botox: Everything to Know Before You Book',
    slug: 'first-time-botox',
    lede: 'A plain-language guide for first-timers: what to ask, what to avoid, and what a good result actually looks like.',
    coverImageUrl: 'https://picsum.photos/seed/guide-first-botox/1080/520',
    category: 'article', treatmentSlug: 'botox',
    readTimeMin: 8, sourcesCount: 5,
    authorSlug: 'maya-iyer', reviewerSlug: 'lena-park-md',
    lastMedicallyReviewed: '2026-06-01', publishedAt: '2026-06-01',
  },
  {
    title: 'Botox vs Filler: What Is the Difference?',
    slug: 'botox-vs-filler',
    lede: 'Botox relaxes muscles. Filler adds volume. Both are injectables, but they solve different problems. A clear breakdown of when each is right.',
    coverImageUrl: 'https://picsum.photos/seed/guide-vs-filler/1080/520',
    category: 'article',
    readTimeMin: 7, sourcesCount: 4,
    authorSlug: 'hannah-reyes', reviewerSlug: 'marcus-hill-md',
    lastMedicallyReviewed: '2026-06-01', publishedAt: '2026-06-01',
  },
  {
    title: 'Red Flags to Watch for Before Booking an Injector',
    slug: 'red-flags',
    lede: 'From unlicensed providers to sky-high unit counts, here are the warning signs that a practice is not worth your trust.',
    coverImageUrl: 'https://picsum.photos/seed/guide-red-flags/1080/520',
    category: 'article',
    readTimeMin: 6, sourcesCount: 4,
    authorSlug: 'devin-rao', reviewerSlug: 'aisha-bello-md',
    lastMedicallyReviewed: '2026-06-01', publishedAt: '2026-06-01',
  },
  {
    title: 'Is Botox Safe? A Physician Review',
    slug: 'is-botox-safe',
    lede: 'The evidence on Botox safety at aesthetic doses, long-term use, and who should not get it. Reviewed by a board-certified dermatologist.',
    coverImageUrl: 'https://picsum.photos/seed/guide-safe/1080/520',
    category: 'treatment-guide', treatmentSlug: 'botox',
    readTimeMin: 9, sourcesCount: 7,
    authorSlug: 'maya-iyer', reviewerSlug: 'lena-park-md',
    lastMedicallyReviewed: '2026-06-01', publishedAt: '2026-06-01',
  },
  {
    title: 'Botox Side Effects: What Is Normal and What Is Not',
    slug: 'botox-side-effects',
    lede: 'Bruising and headache are normal. Ptosis and asymmetry are not. A clinical breakdown of what to expect and when to call your provider.',
    coverImageUrl: 'https://picsum.photos/seed/guide-side-effects/1080/520',
    category: 'treatment-guide', treatmentSlug: 'botox',
    readTimeMin: 8, sourcesCount: 6,
    authorSlug: 'maya-iyer', reviewerSlug: 'james-whitaker-do',
    lastMedicallyReviewed: '2026-06-01', publishedAt: '2026-06-01',
  },
  {
    title: 'MD vs NP vs RN: Who Should Inject You?',
    slug: 'md-vs-np-vs-rn',
    lede: 'Credentials matter, but experience and judgment matter more. A breakdown of what each license means and the questions to ask before you book.',
    coverImageUrl: 'https://picsum.photos/seed/guide-credentials/1080/520',
    category: 'expert-qa',
    readTimeMin: 7, sourcesCount: 3,
    authorSlug: 'devin-rao', reviewerSlug: 'priya-shah-md',
    lastMedicallyReviewed: '2026-06-01', publishedAt: '2026-06-01',
  },
]
...
export const faqs = [
  ...
  // City-scoped FAQs
  { question: 'How much does Botox cost in New York City?', answer: 'NYC average is $14 to $18 per unit. Most patients pay $400 to $850 per session depending on the units used and the provider\'s credentials. Upper East Side and Tribeca are highest. Brooklyn and Queens are typically 15 to 25 percent lower.', scope: 'location', cityTag: 'New York', serviceTag: 'Botox', sortRank: 20 },
  { question: 'Do I need an MD, or can a nurse practitioner inject Botox in NY?', answer: 'In New York State, NPs and PAs can legally inject under physician supervision. Both can do excellent work. Ask about their supervising physician, their training, and how long they have been injecting full-time.', scope: 'location', cityTag: 'New York', sortRank: 21 },
  { question: 'What\'s the average tip for an injector in NYC?', answer: 'Tipping is not expected for injectables in a medical setting. If your injector also offers facials or other spa services as part of your visit, tipping on those is appropriate. The Botox or filler itself, no tip needed.', scope: 'location', cityTag: 'New York', sortRank: 22 },
  { question: 'Which neighborhoods have the best Botox injectors in NYC?', answer: 'Upper East Side and Tribeca have the highest concentration of board-certified dermatologists. Midtown and Flatiron lean heavier on aesthetic-focused practices. Williamsburg and Park Slope have excellent NPs and PAs at more accessible prices. Pick by injector, not by zip code.', scope: 'location', cityTag: 'New York', sortRank: 23 },
  { question: 'Can I get same-day Botox in NYC?', answer: 'Yes, but only at providers who offer same-day slots. Use the "Same-day available" filter to narrow the list. A quality first-time consultation usually takes 30 to 45 minutes, so plan accordingly.', scope: 'location', cityTag: 'New York', sortRank: 24 },
  { question: 'How much does lip filler cost in Miami?', answer: 'Miami averages $750 to $1,100 per syringe. Brickell and South Beach lean higher. Most patients start with one syringe and decide on a second at the 2-week follow-up.', scope: 'location', cityTag: 'Miami', serviceTag: 'Lip Filler', sortRank: 25 },
]
