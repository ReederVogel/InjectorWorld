    ...
    sections: [
      {
        heading: 'Northeast',
        links: [
          { label: 'New York City', href: '/botox/new-york/new-york-ny' },
          { label: 'Boston', href: '/botox/massachusetts/boston-ma' },
          { label: 'Washington DC', href: '/botox/washington-dc/washington-dc' },
          { label: 'Philadelphia', href: '/botox/pennsylvania/philadelphia-pa' },
        ],
      },
      {
        heading: 'West',
        links: [
          { label: 'Los Angeles', href: '/botox/california/los-angeles-ca' },
          { label: 'San Francisco', href: '/botox/california/san-francisco-ca' },
          { label: 'Seattle', href: '/botox/washington/seattle-wa' },
          { label: 'Phoenix', href: '/botox/arizona/phoenix-az' },
          { label: 'Denver', href: '/botox/colorado/denver-co' },
          { label: 'Portland', href: '/botox/oregon/portland-or' },
          { label: 'San Diego', href: '/botox/california/san-diego-ca' },
        ],
      },
      {
        heading: 'South & Midwest',
        links: [
          { label: 'Miami', href: '/botox/florida/miami-fl' },
          { label: 'Atlanta', href: '/botox/georgia/atlanta-ga' },
          { label: 'Houston', href: '/botox/texas/houston-tx' },
          { label: 'Dallas', href: '/botox/texas/dallas-tx' },
          { label: 'Austin', href: '/botox/texas/austin-tx' },
          { label: 'Nashville', href: '/botox/tennessee/nashville-tn' },
          { label: 'Chicago', href: '/botox/illinois/chicago-il' },
        ],
      },
    ],
    feature: {
      ...
      cta: { label: 'See 1,240 injectors', href: '/botox/new-york/new-york-ny' },
    },
  },
  {
    key: 'guides',
