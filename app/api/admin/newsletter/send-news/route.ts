  ...
  try {
    await payload.create({
      ...
      data: {
        ...
        summary: `newsletter send-news "${article.title}" to audience "${audience}": ${sent} sent, ${failed} failed`,
      },
    })
  } catch (err) {
    payload.logger.error(`[audit] failed to log newsletter send-news: ${err}`)
  }
