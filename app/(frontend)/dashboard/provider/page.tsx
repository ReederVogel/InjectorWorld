...
function TierBanner({ tier, profileViewCount, bookingCount }: { tier: Tier; profileViewCount: number; bookingCount: number }) {
    ...
    <div className={`rounded-2xl border p-5 mb-10 ${TIER_COLOR[tier]}`}>
      <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
        <div className="flex items-center gap-3">
          ...
          {tier === 'free' && (
            <span className="text-body-sm text-ink-secondary">Verification and organic ranking included. Always.</span>
          )}
        </div>
        {isUpgradeable && (
          <a href="/pricing" className="inline-flex items-center gap-1.5 text-body-sm font-semibold text-brand-accent hover:underline">
            Upgrade plan
      ...
      {showAnalytics ? (
        ...
        <div className="flex items-center gap-3 text-body-sm text-ink-secondary">
          ...
          <span>
            Profile view analytics are available on the{' '}
