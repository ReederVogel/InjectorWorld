  ...
  fields: [
    {
      ...
      tabs: [
        {
          label: 'Basic Info',
          admin: { description: 'Core identity fields. providerId and slug are set by the importer and must be unique.' },
          fields: [
        ...
        },
        {
          ...
          admin: { description: 'State license details and NPI. Used for the verified badge on the public profile.' },
          fields: [
            {
        ...
        {
          label: 'Profile & Media',
          admin: { description: 'Provider bio, headshot, languages, and gender. Shown on the public profile page.' },
          fields: [
        ...
        },
        {
          ...
          admin: { description: 'Services offered, specialty tags, price points, and loyalty program affiliations.' },
          fields: [
            {
        ...
        },
        {
          ...
          admin: { description: 'Appointment types, virtual consult flag, and online contact / social links.' },
          fields: [
        ...
        },
        {
          ...
          admin: { description: 'Ratings, editorial pins, subscription billing, claim status, and import provenance. Not visible to providers.' },
          fields: [
            {
              type: 'collapsible',
              label: 'Ratings',
              admin: { initCollapsed: true, description: 'Computed from imported reviews. Do not edit by hand — these are trust signals.' },
              fields: [
                {
            ...
            },
            {
              type: 'collapsible',
              label: 'Claim',
              admin: { initCollapsed: true, description: 'Set automatically when a provider completes the claim flow. Do not edit by hand.' },
              fields: [
                {
                  name: 'claimed',
                  type: 'checkbox',
